...
public class SwfJavaExporter {
    ...
    public void exportJavaCode(SWF swf, GraphTextWriter writer) throws IOException {
        ...
        writer.append("package com.com.jpexs.decompiler.flash.exporters.swf;").newLine();
        writer.newLine();
        writer.append("import com.com.jpexs.decompiler.flash.SWF;").newLine();
        writer.append("import com.com.jpexs.decompiler.flash.SWFCompression;").newLine();
        writer.append("import com.com.jpexs.decompiler.flash.tags.*;").newLine();
        writer.append("import com.com.jpexs.decompiler.flash.types.*;").newLine();
        writer.append("import com.com.jpexs.decompiler.flash.types.filters.*;").newLine();
        writer.append("import com.com.jpexs.decompiler.flash.types.shaperecords.*;").newLine();
        writer.append("import com.com.jpexs.helpers.ByteArrayRange;").newLine();
