    ...
    public void beginGradientFill(int type, GRADRECORD[] gradientRecords, Matrix matrix, int spreadMethod, int interpolationMethod, float focalPointRatio) {
        ...
        switch (type) {
            ...
            case FILLSTYLE.RADIAL_GRADIENT: {
                ...
                fillPaint = new RadialGradientPaint(new Point(0, 0), 16384, ratiosArr, colorsArr, cm);
                fillTransform = matrix.toTransform();
            }
            break;
            case FILLSTYLE.FOCAL_RADIAL_GRADIENT: {
                ...
                fillPaint = new RadialGradientPaint(new Point(0, 0), 16384, new Point((int) (focalPointRatio * 16384), 0), ratiosArr, colorsArr, cm, cstype, AffineTransform.getTranslateInstance(0, 0));
                fillTransform = matrix.toTransform();
            }
            break;
        }
    ...
    public void beginBitmapFill(int bitmapId, Matrix matrix, boolean repeat, boolean smooth, ColorTransform colorTransform) {
        ...
        if (imageTag != null) {
            ...
            if (img != null) {
                ...
                fillPaint = new TexturePaint(img.getBufferedImage(), new Rectangle(img.getWidth(), img.getHeight()));
                fillTransform = matrix.toTransform();
                return;
            }
        }
    ...
    public void lineGradientStyle(int type, GRADRECORD[] gradientRecords, Matrix matrix, int spreadMethod, int interpolationMethod, float focalPointRatio) {
        ...
        switch (type) {
            ...
            case FILLSTYLE.RADIAL_GRADIENT: {
                ...
                linePaint = new RadialGradientPaint(new Point(0, 0), 16384, ratiosArr, colorsArr, cm);
                lineTransform = matrix.toTransform();
            }
            break;
            case FILLSTYLE.FOCAL_RADIAL_GRADIENT: {
                ...
                linePaint = new RadialGradientPaint(new Point(0, 0), 16384, new Point((int) (focalPointRatio * 16384), 0), ratiosArr, colorsArr, cm, cstype, AffineTransform.getTranslateInstance(0, 0));
                lineTransform = matrix.toTransform();
            }
            break;
        }
